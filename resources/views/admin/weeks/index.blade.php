                    ...
                    <table class="table table-hover align-middle">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-center d-none d-lg-table-cell">Assessment</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center d-none d-md-table-cell">
                                    ...
                                    @if($week->contents->where('is_required', true)->count() > 0)
                                        <span class="badge badge-primary">{{ $week->contents->where('is_required', true)->count() }}</span>
                                    @endif
                                </td>
                                    ...
                                    @if($week->has_assessment)
                                        @if($week->assessment)
                                            @if($week->assessment->is_active)
                                                <span class="badge badge-success" title="Assessment Active">
                                                    ✓ {{ $week->assessment->questions->count() }}Q
                                                </span>
                                            @else
                                                <span class="badge badge-warning" title="Assessment Inactive">
                                                    ⚠ {{ $week->assessment->questions->count() }}Q
                                                </span>
                                            @endif
                                        @else
                                            <span class="badge badge-secondary" title="No assessment created">
                                                ✗ Not Created
                                            </span>
                                        @endif
                                    @else
